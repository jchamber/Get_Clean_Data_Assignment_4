...
Project of Getting and Cleaning Data course on Coursera, - February 2018
...
clone this repository: download compressed raw data
...
In the repository root directory you find the secTidyset.txt with the tidy data set.
